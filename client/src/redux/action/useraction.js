...
export const getallartist = () => async (dispatch) => {
  try {
    ...
    // const api = `http://localhost:8000/common/getallartist`;
    ...
    if (res.status === 200) {
      ...
      console.log(msg.response); // Log the artist data
      //console.log("rohit kumar testing"); // Log the artist data
    }
  } catch (err) {
    console.log(err);
  }
...
export const getallsong = (username) => async (dispatch) => {
  try {
    ...
    if (res.status === 200) {
      ...
      console.log("rohit kumar testing");
    }
  } catch (err) {
    console.log(err);
  }
