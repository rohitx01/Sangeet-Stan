  ...
  useEffect(() => {
    if (store.user.allsong.length !== 0) {
      ...
      while (randoms.length !== 8) {
        ...
        if (
          randoms.indexOf(randomsong) === -1 &&
          (randomsong.language === "english" || randomsong.language === "hindi")
        ) {
  ...
  return (
    <div className="songs">
      ...
      <div className="heading">
        <h1>
          You may like <PlayCircleIcon className="play" />
        </h1>
        <p
          onClick={(e) => {
            e.preventDefault();
              ...
              >
                ...
                <div className="below">
                  <div className="left">
                    ...
                    <p className="ppp">{item.dummyartist}</p>
                  </div>
                  <div className="right">
